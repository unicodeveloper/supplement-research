...
export default function ResearchResults({ result, isLoading, onReset, onCancel, isCancelling }: ResearchResultsProps) {
  ...
  return (
    <div className="w-full">
      ...
      <div className="rounded-lg bg-[var(--card-bg)] border border-[var(--border-color)] shadow-notion-sm max-h-[60vh] sm:max-h-[calc(100vh-160px)] overflow-y-auto">
        {/* Markdown Report */}
        ...
        {result.sources && result.sources.length > 0 && (
          <div className="px-4 sm:px-8 py-4 sm:py-6 border-t border-[var(--border-color)] bg-[var(--background-secondary)]">
